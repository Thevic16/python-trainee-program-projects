...
connection_string_orig = os.getenv('DATABASE_URL')

connection_string = connection_string_orig.replace("postgres", "postgresql")
...
if __name__ == '__main__':
    if os.getenv('DEBUG_STATE') == 'True':
        app.run(port=os.getenv('PORT'), host='0.0.0.0', debug=True)
