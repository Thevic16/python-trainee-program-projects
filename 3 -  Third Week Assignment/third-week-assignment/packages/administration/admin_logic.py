...
class AdminLogic:
    ...
    def delete_task(cls, id_task: int):
        ...
        try:
            ...
            Logger.error(f'Key {id_task} not found in the dictionary.\n')
        else:
            # This line create an infinite loop
    ...
    def load_data_from_list(cls, admin_logic_list:
        ...
        try:
            ...
            Logger.error('Index Error when load list data.\n'
                         f'Error: {err} \n')
    ...
    def load_todo_lists(cls, todo_lists_dic: list[dict]):
        """
        Help to load the todo list from the
        list representation of the class
        Args:
            todo_lists_dic (list[dict]): List of
            dictionaries with todo list data
        Raises:
        ...
        try:
            ...
            Logger.error(f'Key not found in the dictionary. '
                         f'Error: {err}\n')
